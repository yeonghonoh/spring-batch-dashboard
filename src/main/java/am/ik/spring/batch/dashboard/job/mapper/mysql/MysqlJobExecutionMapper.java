...
public class MysqlJobExecutionMapper implements JobExecutionMapper {

	private final JdbcClient jdbcClient;

	public MysqlJobExecutionMapper(JdbcClient jdbcClient) {
	...
	public PageResponse<JobExecution> findJobExecutions(JobExecutionsParams params) {
		...
		List<JobExecution> content = this.jdbcClient.sql("""
				...
				AND (:startDateFrom IS NULL OR je.START_TIME >= :startDateFrom)
				AND (:startDateTo IS NULL OR je.START_TIME <= :startDateTo)
				ORDER BY
				    je.START_TIME DESC
